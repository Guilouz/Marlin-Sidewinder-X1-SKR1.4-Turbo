...
#define Z_STEPPER_AUTO_ALIGN
  ...
  //#define Z_STEPPER_ALIGN_XY { {  28, 150 }, { 300,  150 } }
...
//#define CUSTOM_USER_MENUS
  ...
  #define USER_SCRIPT_DONE "M117 Script utilisateur effectué"
  ...
  #define USER_DESC_3 "Préchauffer pour " PREHEAT_2_LABEL
  #define USER_GCODE_3 "M140 S" STRINGIFY(PREHEAT_2_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_2_TEMP_HOTEND)

  #define USER_DESC_4 "Nivellement"
  #define USER_GCODE_4 "M140 S" STRINGIFY(PREHEAT_1_TEMP_BED) "\nG28\nG29"

  #define USER_DESC_5 "Home & Infos"
